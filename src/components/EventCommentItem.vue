<template>
  <div class="event-comment-item d-flex m-2 p-2 bg-white border">
    <div class="event-comment-item__profile mr-2">
      <b-icon icon="person-circle" font-scale="3"/>
    </div>
